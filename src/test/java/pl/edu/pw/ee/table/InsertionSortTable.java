...
public class InsertionSortTable {
    ...
    public void createOptimisticTable() {
        try(BufferedWriter fileWriter = new BufferedWriter(new FileWriter("tables/insertion_optimistic.txt"))) {
            for(int i=1; i<=50; i++){
                int length = i*200;
    ...
    public void createPessimisticTable() {
        try(BufferedWriter fileWriter = new BufferedWriter(new FileWriter("tables/insertion_pessimistic.txt"))) {
            for(int i=1; i<=50; i++){
                int length = i*200;
                double[] array = new double[length];
                array[0] = random.nextDouble();
    ...
    public void createRandomTable() {
        try(BufferedWriter fileWriter = new BufferedWriter(new FileWriter("tables/insertion_random.txt"))) {
            for(int i=1; i<=50; i++){
                int length = i*200;
                double[] array = new double[length];
                array[0] = random.nextDouble();
